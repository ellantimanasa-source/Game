-- Force drop all versions of the submit function
drop function if exists public.submit_score_with_rank(text, integer, bigint, integer, integer, integer, integer, integer, integer, integer, text) cascade;
drop function if exists public.submit_score_with_rank(text, integer, bigint, integer, integer, integer, integer, integer, integer, integer, text, jsonb, text, text, bigint, integer, integer) cascade;
drop function if exists public.submit_score_with_rank cascade;
