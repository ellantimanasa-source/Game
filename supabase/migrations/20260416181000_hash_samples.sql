alter table public.scores
  add column if not exists "clickSamples" jsonb not null default '[]'::jsonb,
...
revoke all on function public.submit_score_with_rank(
  text, integer, bigint, integer, integer, integer, integer, integer, integer, integer, text, jsonb, text, text, integer, integer, integer
) from public;
