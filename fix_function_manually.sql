-- Run this in Supabase SQL Editor to fix the function signature issue
-- Step 1: Drop ALL versions of the function (handles multiple overloads)
DO $$ 
DECLARE 
    r RECORD;
BEGIN
    FOR r IN (
        ...
        FROM pg_proc 
        WHERE proname = 'submit_score_with_rank' 
